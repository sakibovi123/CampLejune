                ...
                <div className='row'>
                    ...
                    <div className='col-md-6'>
                        <div class="container">
                            ...
                            <p class="card-text">camp lejeune lawsuit wate at the Marine Corps camp in Jacksonville, North Carolina, was found to have been contaminated with benzene, trichloroethylene and perchloroethylene among others between 1953 to 1987. In the time since, residents of the base have experienced severe negative side-effects, like Cancer, Renal Toxicity, Infertitlity, Parkinson’s, Myeloma, so payout for camp lejeune.</p>
