...
const Privacy = () => {
  return (
    ...
    <div className='container'>
      <h2>WHO WE ARE</h2>
      <p><span className='weare'>Suggested text:</span> Our website address is: <a href="https://camplejeuneus.com.">https://camplejeuneus.com.</a> </p>
      <h2>COMMENTS</h2>
      ...
      <h2>MEDIA</h2>
      <p><span className='weare'>Suggested text:</span> If you upload images to the website, you should avoid uploading images with embedded location data (EXIF GPS) included. Visitors to the website can download and extract any location data from images on the website.</p>
      <h2>COOKIES</h2>
      ...
      When you log in, we will also set up several cookies to save your login information and your screen display choices. Login cookies last for two days, and screen options cookies last for a year. If you select <span className='ptext'>“Remember Me”</span> , your login will persist for two weeks. If you log out of your account, the login cookies will be removed. <br /> If you edit or publish an article, an additional cookie will be saved in your browser. This cookie includes no personal data and simply indicates the post ID of the article you just edited. It expires after 1 day.</p>
      ...
      <p><span className='weare'>Suggested text:</span> If you request a password reset, your IP address will be included in the reset email.</p>
